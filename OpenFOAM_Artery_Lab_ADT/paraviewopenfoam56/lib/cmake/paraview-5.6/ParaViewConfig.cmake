...
if (__pv_install_tree)
  ...
  set (VTK_CONFIG_FILE "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/VTK/VTKConfig.cmake")
  set (ParaView_CMAKE_DIR "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/CMake")
  set (PARAVIEW_CONFIG_TARGETS_FILE "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/ParaViewTargets.cmake")
endif()
...
SET(PARAVIEW_VERSION_FULL  "5.6.3")
...
if(PARAVIEW_USE_VTKM)
  ...
  if(NOT __vtk_install_tree)
    set(VTKM_CMAKE_DIR "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/VTK/ThirdParty/vtkm/vtk-m/lib/cmake/paraview-5.6/vtkm")
  endif()
...
if (__pv_install_tree)
  ...
  if (WIN32)
    set (PARAVIEW_RUNTIME_DIRS "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/bin")
  else ()
    set (PARAVIEW_RUNTIME_DIRS "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/lib")
  endif ()
  list(APPEND VTK_INCLUDE_DIRS "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build")
  set (PARAVIEW_WWW_DIR "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/www")
endif()
...
if (NOT OFF)
  if (PARAVIEW_ENABLE_PYTHON)
    if (__pv_install_tree)
      set(PARAVIEW_PYTHONPATH "${VTK_INSTALL_PREFIX}/lib/python2.7/site-packages")
    else ()
      set(PARAVIEW_PYTHONPATH "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/lib/python2.7/site-packages")
    endif ()
  endif ()
endif ()
