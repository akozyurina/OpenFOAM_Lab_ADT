...
set(_vtk_installed_prefix "../debian/paraviewopenfoam56/opt/paraviewopenfoam56/lib/cmake/paraview-5.6")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "../debian/paraviewopenfoam56/opt/paraviewopenfoam56")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "../debian/paraviewopenfoam56/opt/paraviewopenfoam56/bin")
  else ()
    set (VTK_RUNTIME_DIRS "../debian/paraviewopenfoam56/opt/paraviewopenfoam56/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/home/ubuntu/OpenFOAM/ThirdParty-dev/ParaView-5.6.3/build/lib")
  endif ()
endif()
